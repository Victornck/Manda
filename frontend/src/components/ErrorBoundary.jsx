  ...
  render() {
    ...
    return (
      <div style={{ minHeight: "100vh", display: "flex", flexDirection: "column", alignItems: "center", justifyContent: "center", textAlign: "center", padding: 24, fontFamily: font.body, color: color.ink, background: color.surface2 }}>
        ...
        <p style={{ fontSize: 16, lineHeight: 1.55, color: color.gray500, maxWidth: 440, margin: "0 0 28px" }}>Tivemos um problema ao carregar esta parte do app. Tente recarregar — se continuar, atualize a página em alguns instantes.</p>
